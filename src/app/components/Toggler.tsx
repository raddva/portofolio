...
export default function Toggler({ darkMode, setDarkMode }: TogglerProps) {
    return (
        <label className="inline-flex items-center relative">
            ...
            />
            <div
                className="relative w-[80px] h-[40px] bg-white peer-checked:bg-black rounded-full after:absolute after:content-[''] after:w-[30px] after:h-[30px] after:bg-gradient-to-r from-orange-500 to-yellow-400 peer-checked:after:from-zinc-900 peer-checked:after:to-zinc-900 after:rounded-full after:top-[5px] after:left-[5px] active:after:w-[35px] peer-checked:after:left-[75px] peer-checked:after:translate-x-[-100%] shadow-sm duration-300 after:duration-300 after:shadow-md"
            ></div>
            <svg
                height="100"
                width="100"
